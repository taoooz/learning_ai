...
| 难度判断 | 节点数量 | 每节点卡片数 | 课程风格 |
|----------|----------|--------------|----------|
| 新手/入门 | 6-8 个 | 4-5 张 | 详细基础，术语解释+大量实例 |
| 进阶 | 4-5 个 | 3-4 张 | 标准结构，核心原理+实践 |
| 高级 | 3-4 个 | 2-3 张 | 精简核心，深入原理+难点 |
