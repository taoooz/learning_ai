...
import { getRedis, isValidInviteCode, isValidInviteCodeFormat, userKey, UserData } from '@/lib/redis'
...
export async function POST(request: NextRequest) {
  try {
    ...
    await getRedis().set(userKey(inviteCode), JSON.stringify(userData))
